...
if __name__ == "__main__":
	...
	df_qa = community_qa(df)
	df_proc = community_proc(df)
	#print(df_qa.groupBy("community_qa").count().distinct().orderBy("community_qa", ascending=False).show())
	#print((df_qa.count(), len(df_qa.columns)))
	#print((df_proc.count(), len(df_qa.columns)))
	#pergunta_1(df_proc)
	#pergunta_2(df_proc)
	#pergunta_3(df_proc)
	#pergunta_4(df_proc)
